  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-32">
        ...
        <p className="text-xl text-charcoal-400 text-center mb-16">
          A license is purchased through the Stripe link. This gives you a clientID you can load into your instance and you can use when contacting support or requesting features. While the license renews every year, it is a perpetual update and support license. Which means if you don't renew a license, you can still use the software but you aren't entitled to support or product updates.
        </p>
      </main>
      <Footer />
    </div>
